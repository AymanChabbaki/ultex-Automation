      ...
      <div class="brand">
        <div class="brand-logo">
          <svg width="102" height="25" viewBox="0 0 102 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M29.0068 24.9438C27.5187 24.9438 26.2668 24.4241 25.3456 23.4793C24.5188 22.6053 24.0464 21.4006 24.0464 20.1723V2.90527H28.6053V19.1094C28.6053 19.5818 28.7234 20.007 28.936 20.3377C29.0068 20.4321 29.0305 20.4794 29.0541 20.503C29.4084 20.9518 29.9753 21.188 30.6131 21.188H41.2426V24.9202H29.0068V24.9438Z" fill="#0159A3"/>
            <path d="M50.3366 12.0469H45.7778V24.944H50.3366V12.0469Z" fill="#0159A3"/>
            <path d="M57.7774 2.9292H38.3136V6.66134H57.7774V2.9292Z" fill="#FFC90D"/>
            <path d="M79.556 2.9292H62.1236V6.66134H79.556V2.9292Z" fill="#FFC90D"/>
            <path d="M67.084 24.944C65.5959 24.944 64.344 24.4243 63.4228 23.4795C62.596 22.6055 62.1236 21.4008 62.1236 20.1725V12.0469H78.9655V15.8263H66.6825V19.1096C66.6825 19.7237 66.8714 20.2434 67.2258 20.6213C67.5801 20.9993 68.0761 21.2119 68.6903 21.2119H79.367V24.944H67.084Z" fill="#FFC90D"/>
            <path d="M96.327 24.9441L92.5949 19.9601L88.8627 24.9441H83.7369L90.0438 16.5114L84.2094 8.76367H89.3351L92.5949 13.0863L95.8309 8.76367H100.957L95.1459 16.5114L101.5 24.9441H96.327Z" fill="#FFC90D"/>
            <path d="M6.3777 24.9439C4.67698 24.9439 3.07075 24.2825 1.86607 23.0778C0.661392 21.8732 0 20.2669 0 18.5662V2.92902H4.84233V15.4246H1.46451L8.92878 22.8889L16.3931 15.4246H13.0152V5.12578H10.1335L15.2592 0L20.385 5.12578H17.8339V18.5662C17.8339 20.2669 17.1726 21.8732 15.9679 23.0778C14.7632 24.2825 13.157 24.9439 11.4562 24.9439H6.3777Z" fill="#0159A3"/>
            <path d="M13.0154 5.10205H15.8026C15.3775 6.33035 14.7633 8.19642 14.1492 10.464C13.7004 12.1175 13.3224 13.771 12.9917 15.4009V5.10205H13.0154Z" fill="#004472"/>
            <path d="M45.7778 12.0469H48.069L45.7778 24.944V12.0469Z" fill="#004472"/>
            <path d="M24.0226 2.9292H25.9123L24.0226 19.1569V2.9292Z" fill="#004472"/>
          </svg>
        </div>
        <div class="brand-sub">Comment Moderation</div>
      </div>
      <nav class="nav">
